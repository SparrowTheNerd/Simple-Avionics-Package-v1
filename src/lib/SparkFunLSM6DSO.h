...
typedef enum {
  ...
  GYROSCOPE_DATA = 0x01,
  ACCELEROMETER_DATA = 0x02,
  TEMPERATURE_DATA = 0x03,
  TIMESTAMP_DATA = 0x04,
  CFG_CHANGE_DATA = 0x05,
  ACCELERTOMETER_DATA_T_2 = 0x06,
  ACCELERTOMETER_DATA_T_1 = 0x07,
  ACCELERTOMETER_DATA_2xC = 0x08,
  ACCELERTOMETER_DATA_3xC = 0x09,
  GYRO_DATA_T_2 = 0x0A,
  GYRO_DATA_T_1 = 0x0B,
  GYRO_DATA_2xC = 0x0C,
  GYRO_DATA_3xC = 0x0D,
...
typedef enum {
	...
	ODR_XL_1666Hz    = 0x80, // High Performance
	ODR_XL_3332Hz    = 0x90, // High Performance
	ODR_XL_6664Hz    = 0xA0, // High Performance
  	ODR_XL_MASK      = 0x0F
} LSM6DSO_ODR_XL_t;
...
typedef enum {
	...
	ODR_GYRO_1666Hz  = 0x80, // High Performance
	ODR_GYRO_3332Hz  = 0x90, // High Performance
	ODR_GYRO_6664Hz  = 0xA0, // High Performance
  	ODR_GYRO_MASK    = 0x0F
